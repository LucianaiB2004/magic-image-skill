...
![点击前后的平静海面与风暴巨浪演示](assets/showcase/calm-to-storm-demo.gif)

> 一张图片，没点开时像是第一页：一艘帆船驶过平静的海面；点开以后，就像翻到第二页：巨浪、暴雨和闪电突然出现。同一张图片，用一次点击呈现两种画面，制造强烈的视觉反差。上方 GIF 只用于演示这个观看过程；项目真正生成和交付的仍是[同一张透明 PNG](assets/showcase/calm-to-storm.png)，不是 GIF。
